...
public class testSorts {
    ...
    public void testBubbleSort(){
        assertArrayEquals(new int[]{},SortAlgorithms.bubbleSort(new int[]{}));

        assertArrayEquals(new int[]{1, 1, 2, 3, 4, 7, 8, 8, 10, 15, 15, 17, 21, 33}, SortAlgorithms.bubbleSort(new int[]{7, 10, 8, 1, 3, 21, 15, 2, 4, 1, 8, 33, 15,17}));

        assertArrayEquals(new int[]{2, 7, 23, 115, 359, 421, 502, 756, 1280, 5000},
                SortAlgorithms.bubbleSort(new int[]{359, 756, 421, 502, 115, 23, 1280, 2, 5000, 7}));

        assertArrayEquals(new int[]{-6, -5, -4, -2, -2, 0, 0, 0, 1, 1, 2, 3, 3, 4, 5},
                SortAlgorithms.bubbleSort(new int[]{0, -2, 3, 0, 1, 2, -4, 0, 5, -6, -5, 1, 3, -2, 4}));
    }
}
